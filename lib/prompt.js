    ...
    functions = [
      {
        ...
        parameters: {
          ...
          properties: {
            ...
            parenting_tips: {
              type: "string",
              description: `Write 1 Modern Result Oriented Practical Parenting Tips for ${name} Emotional Imbalance Challanegs Explain   explain Parenting Tips in Detail how to do it with Detailed guided Execution steps and write Content in simple Easy to Understand English Format.`,
            },
          },
          required: [
            "emotional_state",
