...
export const Planet_Gemstone_Desc = {
  ...
  Jupiter: {
    ...
    Description:
      "Yellow Sapphire is linked to Jupiter and is known for its auspicious and expansive qualities. It is believed to enhance wisdom, prosperity, and good fortune. Wearing a yellow sapphire can bring success, growth, and positive changes, making it ideal for those seeking to improve their financial and personal well-being.",
  },
  Venus: {
    Gemstone: "Diamond",
    Description:
      "Diamond is associated with Venus and is valued for its brilliance and clarity. It is believed to enhance love, beauty, and luxury. Wearing a diamond can bring harmony, success in relationships, and financial prosperity, making it a powerful gemstone for those seeking to attract and enjoy life's pleasures.",
  },
  Saturn: {
    Gemstone: "Blue Sapphire",
    Description:
      "Blue Sapphire is connected to Saturn and is known for its profound and transformative qualities. It is believed to enhance discipline, responsibility, and wisdom. Wearing a blue sapphire can help in overcoming challenges and achieving long-term success, making it beneficial for those seeking stability and personal growth.",
  },
  Rahu: {
...
export const dasa_status_table = {
  Sun: [
  ...
  Venus: [["Venus", "Mercury", "Moon"], []],
  Saturn: [["Mercury"], ["Sun", "Rahu", "Ketu", "Saturn"]],
  Rahu: [
    ["Venus", "Jupiter"],
    ["Rahu", "Ketu", "Saturn", "Sun", "Moon"],
  ],
  Ketu: [
    ["Venus", "Jupiter"],
    ["Rahu", "Ketu", "Saturn", "Sun", "Moon"],
...
export const elements_content = {
  Earth: [
    ...
    },
    {
      ...
      Water:
        "Include storytelling, imaginative play, or water-based activities to enhance emotional depth and adaptability.",
  ...
  Air: [
    ...
    {
      Earth:
        "Include activities like building projects and nature walks to promote stability and patience.",
      Fire: "Engage in high-energy games and physical activities to enhance confidence and motivation.",
      Water:
        "Introduce calming activities like storytelling or water play to foster emotional depth.",
    },
  ],
  Water: [
    ...
    {
      Earth:
        "Engage in hands-on activities like gardening or building to promote stability and confidence.",
  ...
  Fire: [
    ...
    {
      Earth:
        "Encourage activities like building, gardening, and hands-on crafts to promote stability and patience.",
      Water:
        "Introduce water play or storytelling to enhance emotional awareness and adaptability.",
...
export const thithiContent = {
  Pratipada: [
    ...
    ],
    {
      ...
      Execution:
        "Enroll them in martial arts or dance classes to help them discipline their energy. Introduce daily journaling for emotional reflection.",
    },
  ],
  Ditiya: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Set aside an hour daily for puzzles, storytelling, or experiments to enhance learning and decision-making skills.",
    },
  ],
  Tritiya: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Use role-playing to practice standing up for themselves and expressing emotions constructively.",
    },
  ],
  Chaturthi: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Set up an obstacle course at home that includes unexpected challenges to teach patience and adaptability.",
    },
  ],
  Panchami: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Encourage activities like painting, music, or writing, focusing on the process rather than results.",
    },
  ],
  Shashthi: [
    [
    ...
    ["Overly competitive", "Impulsive decisions", "May struggle with teamwork"],
    {
      Name: "Teamwork Building Games",
      Description: "Foster cooperation through group activities.",
      Execution:
        "Organize family board games or team sports to emphasize collaboration.",
    },
  ],
  Saptami: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Rotate leadership roles in group activities, stressing teamwork and listening.",
    },
  ],
  Ashtami: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Encourage daily journaling with writing or drawing to manage intense feelings.",
    },
  ],
  Navami: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Introduce breathing exercises or nature walks to help them decompress and build emotional resilience.",
    },
  ],
  Dashami: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Use activities like 'What if' scenarios to help them think flexibly and embrace change.",
    },
  ],
  Ekadashi: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Spend dedicated time listening to your child's thoughts and guiding them through their concerns without judgment.",
    },
  ],
  Dwadashi: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Encourage activities like reading or hobbies that they can enjoy independently, reinforcing the value of personal space.",
    },
  ],
  Trayodashi: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Create a fun chart with emotions and teach them to label what they feel during different situations to promote self-awareness.",
    },
  ],
  Chaturdashi: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Engage in shared activities like gardening or cooking, fostering open conversations and mutual understanding.",
    },
  ],
  Purnima: [
    [
    ...
    ],
    {
      ...
      Execution:
        "On full moon nights, guide your child in meditation or breathing exercises to calm their emotions.",
    },
  ],
  Amavasya: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Encourage writing or discussing three daily gratitudes to promote a positive mindset.",
    },
  ],
};

export const thithiLord = {
...
export const weekPlanetContent = {
  Sunday: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Provide opportunities where your child can take charge, such as leading a group activity or planning family events. Praise their efforts to build confidence while teaching them to listen to others.",
    },
  ],
  Monday: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Spend quiet time with them, use stories or art to help them express feelings, and ensure they feel safe and supported. Offer reassurance and practice calming activities like deep breathing.",
    },
  ],
  Tuesday: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Enroll them in sports or activities that require teamwork and controlled energy, such as martial arts or group games. Praise their progress and teach them techniques to manage frustration.",
    },
  ],
  Wednesday: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Introduce puzzles, science kits, or activities that require them to use logic and creativity. Use visual schedules to help them stay on task, and praise their achievements.",
    },
  ],
  Thursday: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Incorporate activities that combine fun with learning, like educational games or group projects. Remind them to set achievable goals and celebrate their small successes.",
    },
  ],
  Friday: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Provide opportunities for creative expression, such as drawing, playing an instrument, or dance. Reinforce their strengths and teach them to focus on their true self, not just external opinions.",
    },
  ],
  Saturday: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Introduce activities that mix routine with play, like structured but fun chores or projects. Recognize their hard work, and gently remind them that mistakes are part of learning.",
    },
  ],
};

export const weekPlanet = {
  Sunday: "Sun",
  Monday: "Moon",
  Tuesday: "Mars",
  Wednesday: "Mercury",
...
export const karanamContent = {
  Bava: [
    ...
    ],
    {
      ...
      Execution:
        "Break down big tasks into smaller, manageable steps with a clear timeline. Praise their progress to encourage them to stay focused and complete tasks.",
    },
  ],
  Balava: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Create a timer-based approach where they work on one task for a set period and then take short breaks. This helps improve focus and productivity.",
    },
  ],
  Kaulava: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Help them practice flexibility by gently encouraging them to try new methods or activities with reassurance.",
    },
  ],
  Taitila: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Praise their hard work but reassure them that making mistakes is part of learning. Offer positive reinforcement when they try new things without expecting perfection.",
    },
  ],
  Garaja: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Encourage them to express their needs and feelings. Let them know it's okay to ask for help, and praise collaborative efforts.",
    },
  ],
  Vanija: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Create a priority list for their tasks and set clear goals for each. Help them focus on one thing at a time while encouraging their creativity.",
    },
  ],
  Vishti: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Encourage them to try new methods and take breaks when necessary. Remind them that flexibility is important for growth and managing stress.",
    },
  ],
  Shakuni: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Foster their emotional intelligence by encouraging teamwork and group activities. Teach them to value relationships alongside strategic planning.",
    },
  ],
  Chatushpada: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Encourage them to stay committed to one task at a time and celebrate the completion of small milestones. Use consistency as a reward mechanism.",
    },
  ],
  Nagava: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Encourage them to open up about their feelings and balance their work with social activities. Help them understand the importance of emotional well-being.",
    },
  ],
  Kinstughna: [
    [
    ...
    ],
    {
      ...
      Execution:
        "Teach them to pause and think before acting, especially in important decisions. Implement decision-making steps that involve thinking through pros and cons.",
    },
  ],
};
...
export const healthContent = {
  ...
  Taurus: [
    [
      "Throat and Vocal Cord Issues (hoarseness, thyroid imbalance)",
      "Digestive Sluggishness (slow metabolism, constipation)",
...
export const healthInsights = {
  ...
  Virgo:
    "Virgo in the 6th house indicates a focus on health but a tendency toward worry or stress, which can lead to digestive issues or anxiety. child may be particular about cleanliness or diet. Encourage mindfulness practices, a simple routine, and a fiber-rich diet to maintain gut health. Keeping a calm environment will benefit both mental and physical well-being.",
  Libra:
    "Libra in the 6th house suggests a balanced approach to health but may create concerns around the kidneys, lower back, or skin. child may be sensitive to stress, which can affect digestion or skin health. Encourage relaxation techniques, such as gentle stretching or mindfulness, and a diet that supports kidney health. Regular skin care and staying hydrated are also beneficial for overall well-being.",
  Scorpio:
    "Scorpio in the 6th house indicates intense energy but may bring health challenges related to the reproductive system, bladder, or circulatory system. child could experience issues with intense emotions affecting physical health. Encourage regular physical activity, especially activities that release tension, like swimming or cycling. A balanced diet and stress management will help maintain strong health.",
  Sagittarius:
    "Sagittarius in the 6th house suggests a love for adventure, which could lead to injuries or overindulgence in physical activities. child may be prone to problems related to the hips, thighs, or liver. Encourage outdoor activities, but emphasize safety. A healthy diet with plenty of fruits, vegetables, and liver-supporting foods will promote overall health. Regular checkups for joint health and staying active can keep child healthy and strong.",
  Capricorn:
    "Capricorn in the 6th house indicates a strong and disciplined nature, but health concerns may arise in the bones, joints, or knees. child could experience issues related to stiffness or slow recovery from physical strain. Encourage activities that strengthen bones and joints, like walking or gentle exercise. A diet rich in calcium and vitamin D, along with regular stretching, will help keep child in good health.",
  Aquarius:
    "Aquarius in the 6th house suggests a unique approach to health but may bring issues with the nervous system or circulation. child may experience nervous tension or anxiety, which could affect sleep or energy levels. Encourage mental relaxation techniques, such as meditation or quiet time. A balanced diet that includes brain-boosting foods, along with regular physical activity, will help child maintain a healthy body and mind.",
  Pisces:
    "Pisces in the 6th house indicates a sensitive health nature, with a tendency to experience issues related to the feet, immune system, or emotional well-being. child may be prone to feeling tired or overwhelmed by stress. Encourage a calm, soothing environment and regular physical activity, such as swimming or walking. A diet that supports the immune system and plenty of rest will keep child healthy and balanced.",
};
    ...
    [
      {
        ...
        content:
          "Business, Entrepreneurship, Sports, Engineering, Military Studies, Leadership.",
      },
      {
        title: "Preferred Learning Style",
        content:
          "Hands-on learning, competitive challenges, and individual projects.",
      },
      {
        title: "Mode of Learning",
        content:
          "Interactive learning, leadership roles, practical applications, and real-world tasks.",
      },
    ],
    [
      {
        ...
        content:
          "child prefers to learn by doing, engaging in physical activities, and solving problems through action.",
      },
      {
        title: "Leader",
        content:
          "child is naturally drawn to leadership roles and enjoys being in charge of projects or teams.",
      },
      {
        title: "Competitive",
        content:
          "Thrives in environments where achievements and progress are recognized and rewarded.",
      },
    ],
    ...
    [
      {
        ...
        content:
          "Give child chances to lead group projects or participate in team-based activities.",
      },
      {
        title: "Provide Competitive Challenges",
        content:
          "Set up tasks or challenges where child can compete and measure progress, such as academic competitions or sports.",
      },
      {
        title: "Support Independence",
        content:
          "Allow child to take ownership of their learning process and make decisions about their academic path.",
      },
    ],
  ],
  Taurus: [
    ...
    [
      {
        title: "Subjects of Interest",
        content:
          "Finance, Agriculture, Architecture, Arts, Environmental Science.",
      },
      {
        title: "Preferred Learning Style",
        content:
          "Step-by-step learning, practical applications, and real-world case studies.",
      },
      {
        title: "Mode of Learning",
        content:
          "Structured learning, hands-on projects, fieldwork, and internships.",
      },
    ],
    [
      {
        ...
        content:
          "child excels when applying theoretical knowledge to real-life situations.",
      },
      {
        title: "Methodical",
        content:
          "child prefers to take a steady, consistent approach to learning, focusing on building expertise over time.",
      },
      {
        title: "Determined",
        content:
          "Shows persistence and patience in completing tasks, focusing on long-term success.",
      },
    ],
    ...
    [
      {
        ...
        content:
          "Help child set long-term academic goals and break them into manageable tasks.",
      },
      {
        title: "Support Hands-On Learning",
        content:
          "Provide opportunities for practical, real-world experiences, such as internships or fieldwork.",
      },
      {
        title: "Build Consistency",
        content:
          "Establish a consistent study routine and ensure that child focuses on steady progress rather than rushing through tasks.",
      },
    ],
  ],
  Gemini: [
    ...
    [
      {
        title: "Subjects of Interest",
        content:
          "Technology, Science, Engineering, Languages, Communication, Psychology, Social Sciences.",
      },
      {
        title: "Preferred Learning Style",
        content:
          "Active learning through group discussions, problem-solving, and debates.",
      },
      {
        title: "Mode of Learning",
    ...
    [
      {
        ...
        content:
          "child enjoys exploring new topics independently, often seeking answers through various resources.",
      },
      {
        title: "Analytical",
        content:
          "child excels in breaking down problems into smaller, manageable parts and solving them step by step.",
      },
      {
        title: "Social Learning",
        content:
          "Collaboration with peers in group studies and discussions helps child stay engaged and motivated.",
      },
    ],
    ...
    [
      {
        ...
        content:
          "Dedicate time for discussions on different topics related to child's interests. This can be done after school or on weekends.",
      },
      {
        title: "Encourage Problem-Solving",
        content:
          "Provide real-life challenges that require logical thinking. For example, puzzles, coding tasks, or science experiments.",
      },
      {
        title: "Promote Group Work",
        content:
          "Encourage participation in group activities or projects, where child can engage with peers, share ideas, and learn from others.",
      },
    ],
  ],
  Cancer: [
    ...
    [
      {
        title: "Subjects of Interest",
        content:
          "Psychology, Literature, Social Sciences, Arts, Education, Healthcare.",
      },
      {
        title: "Preferred Learning Style",
        content:
          "Emotional engagement, one-on-one mentorship, small group discussions.",
      },
      {
        title: "Mode of Learning",
        content:
          "A mix of traditional learning with personalized support and hands-on learning.",
      },
    ],
    [
      {
        ...
        content:
          "child connects well with subjects that evoke emotional responses and can relate them to personal experiences.",
      },
      {
        title: "Intuitive Learner",
        content:
          "Relies on gut feelings and intuition to grasp concepts and ideas.",
      },
      {
        title: "Support-Oriented",
        content:
          "Needs encouragement and personalized guidance to feel confident and motivated.",
      },
    ],
    ...
    [
      {
        ...
        content:
          "Ensure child feels emotionally supported and safe while learning. This helps build confidence.",
      },
      {
        title: "Incorporate Emotional Aspects",
        content:
          "Connect subjects with real-life stories, people, or experiences that can emotionally engage child.",
      },
      {
        title: "Encourage Creative Expression",
        content:
          "Allow child to express learning through creative outlets like writing, art, or discussions.",
      },
    ],
  ],
  Leo: [
    ...
    [
      {
        title: "Subjects of Interest",
        content:
          "Performing Arts, Management, Business, Leadership Studies, Marketing, Design.",
      },
      {
        title: "Preferred Learning Style",
        content:
          "Self-directed learning, project-based work, leadership opportunities.",
      },
      {
        title: "Mode of Learning",
        content:
          "Interactive classes, internships, real-world applications, creative workshops.",
      },
    ],
    [
      {
        ...
        content:
          "child enjoys being in the spotlight and leads projects or group activities with ease.",
      },
      {
        title: "Creative",
        content:
          "Thrives when able to express creativity in different forms, such as through design, art, or storytelling.",
      },
      {
        title: "Goal-Oriented",
        content:
          "Focuses on achieving personal and academic goals and enjoys setting challenges for growth.",
      },
    ],
    ...
    [
      {
        ...
        content:
          "Provide opportunities for child to lead projects or take responsibility for group work.",
      },
      {
        title: "Praise Efforts and Achievements",
        content:
          "Recognize and celebrate child's academic and creative accomplishments to boost self-esteem.",
      },
      {
        title: "Incorporate Creativity",
        content:
          "Encourage child to engage in creative outlets like music, drama, or design alongside academic work.",
      },
    ],
  ],
  Virgo: [
    ...
    [
      {
        title: "Subjects of Interest",
        content:
          "Mathematics, Science, Engineering, Healthcare, Data Analysis, Accounting.",
      },
      {
        title: "Preferred Learning Style",
        content:
          "Structured, systematic learning with clear goals and detailed information.",
      },
      {
        title: "Mode of Learning",
        content:
          "Lectures, research, hands-on experimentation, and data analysis.",
      },
    ],
    [
      {
        ...
        content:
          "child excels when working through problems in a step-by-step manner, paying attention to every detail.",
      },
      {
        title: "Logical Thinker",
        content:
          "Enjoys solving complex problems and applying critical thinking to find solutions.",
      },
      {
        title: "Service-Oriented",
        content:
          "Finds satisfaction in work that helps others, particularly in healthcare, social services, or teaching.",
      },
    ],
    ...
    [
      {
        ...
        content:
          "Help child create detailed study schedules, break down tasks into manageable steps, and set academic goals.",
      },
      {
        title: "Encourage Routine Learning",
        content:
          "Create a regular study schedule that allows time for consistent learning and revision.",
      },
      {
        title: "Support Practical Learning",
        content:
          "Provide opportunities for hands-on learning, such as science experiments, real-world problem-solving, or internships.",
      },
    ],
  ],
  Libra: [
    ...
    [
      ...
      },
      {
        title: "Mode of Learning",
        content:
          "Interactive learning with group projects, class discussions, and real-world application.",
      },
    ],
    [
      {
        title: "Diplomatic",
        content:
          "child works well in group settings, often mediating and facilitating cooperation among peers.",
      },
      {
        title: "Creative Thinker",
        content:
          "Enjoys subjects that allow for creative expression and the ability to see multiple perspectives.",
      },
      {
        title: "Analytical",
        content:
          "Has a strong ability to weigh different viewpoints and make balanced, fair decisions.",
      },
    ],
    ...
    [
      {
        ...
        content:
          "Encourage child to participate in group projects or clubs where team dynamics and shared ideas are emphasized.",
      },
      {
        title: "Foster Open Conversations",
        content:
          "Set aside time for discussions on various topics, encouraging child to express ideas and consider different viewpoints.",
      },
      {
        title: "Support Creative Projects",
        content:
          "Provide resources for artistic or creative work, such as art supplies or access to design platforms.",
      },
    ],
  ],
  Scorpio: [
    ...
    [
      {
        title: "Subjects of Interest",
        content:
          "Psychology, Research, Medicine, Science, Criminal Justice, Forensic Studies.",
      },
      {
        title: "Preferred Learning Style",
        content:
          "Independent research, critical thinking, problem-solving, and deep analysis.",
      },
      {
        title: "Mode of Learning",
        content:
          "Project-based learning, research, case studies, and experiential learning.",
      },
    ],
    [
      {
        ...
        content:
          "child works best when tackling complex subjects or problems, showing persistence and dedication.",
      },
      {
        title: "Investigative",
        content:
          "Loves to dig deep into subjects, seeking to understand the underlying causes or truths.",
      },
      {
        title: "Resilient",
        content:
          "child thrives in challenging academic environments that require perseverance and self-discipline.",
      },
    ],
    ...
    [
      {
        ...
        content:
          "Provide opportunities for child to explore topics in-depth through books, online resources, and research projects.",
      },
      {
        title: "Challenge with Complex Problems",
        content:
          "Present problems or challenges that require critical thinking and analysis.",
      },
      {
        title: "Foster Self-Reflection",
        content:
          "Encourage child to reflect on academic progress and identify areas for improvement.",
      },
    ],
  ],
  Sagittarius: [
    ...
    [
      {
        title: "Subjects of Interest",
        content:
          "Philosophy, International Relations, Travel & Tourism, Literature, Anthropology.",
      },
      {
        title: "Preferred Learning Style",
        content:
          "Independent learning, exploration, broad-based knowledge, and global perspectives.",
      },
      {
        title: "Mode of Learning",
        content:
          "Online learning, travel-based learning, cultural exchange, and experiential education.",
      },
    ],
    [
      {
        title: "Explorer",
        content:
          "child loves exploring new ideas, cultures, and philosophies, often seeking out experiences outside the traditional classroom.",
      },
      {
        title: "Big-Picture Thinker",
        content:
          "Focuses on understanding broad concepts and seeing the connections between different areas of knowledge.",
      },
      {
        title: "Optimistic",
        content:
          "Approaches learning with enthusiasm, always looking for new opportunities and experiences.",
      },
    ],
    ...
    [
      {
        ...
        content:
          "Encourage experiences that expand child's worldview, such as cultural trips or exchange programs.",
      },
      {
        title: "Introduce Diverse Topics",
        content:
          "Expose child to a wide range of subjects, including philosophy, world history, or global issues.",
      },
      {
        title: "Promote Independent Learning",
        content:
          "Allow child to pursue self-directed projects and research that align with personal interests.",
      },
    ],
  ],
  Capricorn: [
    ...
    [
      {
        title: "Subjects of Interest",
        content:
          "Business, Finance, Engineering, Law, Accounting, Architecture.",
      },
      {
        title: "Preferred Learning Style",
        content:
          "Structured learning with clear goals, practical applications, and real-world experiences.",
      },
      {
        title: "Mode of Learning",
        content:
          "Lectures, hands-on projects, internships, and professional training programs.",
      },
    ],
    [
      {
        ...
        content:
          "child enjoys applying theoretical knowledge to real-world situations and solving practical problems.",
      },
      {
        title: "Goal-Oriented",
        content:
          "Focuses on setting and achieving long-term academic and professional goals.",
      },
      {
        title: "Disciplined and Responsible",
        content:
          "Works diligently, often without needing external motivation, to achieve success.",
      },
    ],
    ...
    [
      {
        ...
        content:
          "Encourage child to set clear academic and career goals, breaking them down into manageable steps.",
      },
      {
        title: "Provide Practical Opportunities",
        content:
          "Offer real-world learning experiences, such as internships, work experiences, or projects related to child's academic interests.",
      },
      {
        title: "Instill a Strong Work Ethic",
        content:
          "Emphasize the importance of hard work, discipline, and persistence in achieving goals.",
      },
    ],
  ],
  Aquarius: [
    ...
    [
      {
        title: "Subjects of Interest",
        content:
          "Technology, Robotics, Environmental Science, Sociology, Political Science, Innovation.",
      },
      {
        title: "Preferred Learning Style",
        content:
          "Independent study, brainstorming, and collaboration on innovative projects.",
      },
      {
        title: "Mode of Learning",
        content:
          "Hands-on projects, online learning, group collaboration, and fieldwork.",
      },
    ],
    [
      {
        ...
        content:
          "child excels in exploring new ideas and creating innovative solutions.",
      },
      {
        title: "Idealistic",
        content:
          "Driven by a desire to make a difference in the world, child focuses on subjects that can bring about social change.",
      },
      {
        title: "Collaborative",
        content:
          "Enjoys working with others on projects that have a wider impact on society.",
      },
    ],
    ...
    [
      {
        ...
        content:
          "Provide resources like books, documentaries, and online courses that allow child to explore new and unconventional ideas.",
      },
      {
        title: "Support Social Impact Projects",
        content:
          "Help child get involved in community projects or initiatives that focus on making a positive difference.",
      },
      {
        title: "Facilitate Brainstorming Sessions",
        content:
          "Engage in regular brainstorming activities where child can share ideas and develop creative solutions.",
      },
    ],
  ],
  Pisces: [
    ...
    [
      {
        title: "Subjects of Interest",
        content:
          "Psychology, Arts, Music, Literature, Spirituality, Philosophy.",
      },
      {
        title: "Preferred Learning Style",
        content:
          "Creative exploration, introspection, and imaginative thinking.",
      },
      {
        title: "Mode of Learning",
        content:
          "Art-based learning, creative writing, individual projects, and experiential learning.",
      },
    ],
    [
      {
        title: "Intuitive Learner",
        content:
          "child often relies on intuition and imagination to grasp new concepts.",
      },
      {
        title: "Empathetic",
        content:
          "Finds it easy to connect with others on an emotional level, making social sciences or psychology appealing.",
      },
      {
        title: "Creative Thinker",
        content:
          "Loves subjects that allow for self-expression, creativity, and artistic exploration.",
      },
    ],
    ...
    [
      {
        ...
        content:
          "Encourage activities like drawing, painting, music, or writing that allow child to express their emotions.",
      },
      {
        title: "Support Emotional Reflection",
        content:
          "Help child connect academic subjects to personal experiences, fostering deeper understanding and emotional engagement.",
      },
      {
        title: "Allow Flexibility in Learning",
        content:
          "Give child the freedom to explore subjects in their own way, without strict rules or rigid timelines.",
      },
    ],
  ],
};
...
export const carrer = {
  Aries: [
    ...
    {
      Entrepreneurship:
        "Aries individuals are natural leaders and risk-takers, making them highly suited for starting their own business or leading innovative projects.",
      "Sales and Marketing":
        "Careers that involve persuasion, competitive spirit, and a direct approach, such as sales or marketing, are ideal for Aries individuals.",
      "Sports and Athletics":
        "Aries' high energy and drive for competition can lead to success in professional sports or athletic careers.",
      "Military or Law Enforcement":
        "Leadership and assertiveness make Aries well-suited for military careers or roles in law enforcement, where decisiveness and courage are essential.",
      "Emergency Services":
        "Careers in fields like firefighting, paramedics, or other high-stress, action-driven jobs fit Aries' desire to act quickly and decisively.",
    },
  ],
  Taurus: [
    ...
    {
      "Finance and Banking":
        "Taurus' strong financial instincts make them well-suited for careers in banking, investment, or financial planning.",
      "Real Estate":
        "Careers in real estate, property management, or interior design align with Taurus' appreciation for beauty and material success.",
      "Luxury Goods and Retail":
        "Working with luxury products, jewelry, or high-end services can bring Taurus both success and fulfillment.",
      "Agriculture and Farming":
        "A deep connection to the earth can lead to success in agriculture, farming, or environmental conservation.",
      "Culinary Arts":
        "Careers in cooking, food management, or restaurant ownership resonate with Taurus' love for comfort and sensual pleasures.",
    },
  ],
  Gemini: [
    "The 10th house in astrology represents career, fame, and public life. If a child's 10th house is in Gemini, it indicates versatility, adaptability, and a communicative approach to career. Gemini is ruled by Mercury, the planet of communication, intellect, and learning. Individuals with Gemini in the 10th house are likely to seek careers that involve intellectual stimulation, social interaction, and opportunities to express their ideas. They thrive in dynamic environments and are often drawn to professions that require quick thinking and multitasking.",
    {
      "Media and Journalism":
        "Gemini individuals' strong communication skills and curiosity make them highly suited for careers in writing, reporting, or broadcasting.",
      "Teaching and Education":
        "Their love for sharing knowledge and engaging with others makes education a natural fit for Gemini.",
      "Public Relations and Marketing":
        "Careers that involve networking, creativity, and persuasion, such as public relations or advertising, align well with Gemini's strengths.",
      "Travel and Tourism":
        "Gemini's adventurous nature and adaptability are ideal for roles in travel, tourism, or as a tour guide.",
      "Technology and IT":
        "With their quick learning ability and love for intellectual challenges, Gemini can excel in technology-driven careers, such as programming or digital marketing.",
    },
  ],
  Cancer: [
    "If a child's 10th house is in Cancer, it indicates a nurturing, empathetic, and intuitive approach to career. Cancer is ruled by the Moon, representing emotions, home, and family. Individuals with Cancer in the 10th house are often drawn to careers where they can care for others, create emotional connections, or build a secure, supportive environment. They value emotional fulfillment and a strong sense of belonging in their careers.",
    {
      "Healthcare and Nursing":
        "Careers in nursing, therapy, or healthcare provide an opportunity to care for others, aligning with Cancer's nurturing instincts.",
      "Teaching and Counseling":
        "Cancer's empathetic nature makes them great counselors, teachers, or social workers.",
      "Hospitality and Event Planning":
        "Organizing events, managing hotels, or working in hospitality appeals to Cancer's desire to create safe, welcoming environments.",
      Psychology:
        "Counseling, therapy, or psychological research offer emotional depth and connection for Cancer.",
      "Home Management or Interior Design":
        "Careers that involve creating comfort, such as interior design or home organization, align with Cancer's emotional and family-centered approach.",
    },
  ],
  Leo: [
    "With the 10th house in Leo, career ambitions are driven by a desire for recognition, leadership, and creativity. Leo is ruled by the Sun, symbolizing vitality, confidence, and creativity. Individuals with Leo in the 10th house seek careers that allow them to shine, express themselves, and be in the spotlight. They excel in leadership positions and often desire to inspire or entertain others.",
    {
      "Entertainment and Performing Arts":
        "Leo's love for the spotlight makes them ideal for careers in acting, music, dance, or other performance-based fields.",
      "Leadership Roles":
        "Whether in business or politics, Leo thrives in positions of power and influence where they can lead and inspire others.",
      "Public Speaking or Media":
        "Leo's confidence and charisma make them well-suited for roles in media, journalism, or motivational speaking.",
      "Creative Director or Artist":
        "Careers in fashion, design, or visual arts provide an outlet for Leo's creativity and desire for recognition.",
      "Event Management":
        "Organizing and leading large-scale events or public functions offers Leo the chance to be in charge and receive recognition.",
    },
  ],
  Virgo: [
    "With Virgo in the 10th house, career success is linked to precision, practicality, and a strong work ethic. Virgo is ruled by Mercury, the planet of communication and organization. Individuals with Virgo in the 10th house are often drawn to careers that require attention to detail, problem-solving, and a methodical approach. They excel in roles that demand efficiency, organization, and service to others.",
    {
      "Healthcare and Medicine":
        "Careers in medicine, nursing, or allied health fields where attention to detail and care are critical are ideal for Virgo.",
      "Accounting or Finance":
        "Virgo's analytical skills and ability to manage finances make them well-suited for careers in accounting, auditing, or financial planning.",
      "Research or Science":
        "Virgo's methodical and detail-oriented nature thrives in research, laboratory work, or scientific inquiry.",
      Education:
        "Teaching, tutoring, or educational administration allows Virgo to use their organizational skills while helping others.",
      "Project Management or Consulting":
        "Virgo excels in roles that require structure, organization, and efficiency, making them great project managers or consultants.",
    },
  ],
  Libra: [
    ...
    {
      "Law and Mediation":
        "Libra's strong sense of justice and fairness makes them well-suited for careers in law, mediation, or arbitration.",
      "Diplomacy and Foreign Affairs":
        "Diplomatic roles or positions in international relations appeal to Libra's desire for balance and peace.",
      "Fashion and Design":
        "Careers in fashion, interior design, or styling tap into Libra's love for beauty and aesthetics.",
      "Public Relations":
        "Working in PR, marketing, or communications allows Libra to use their diplomatic and relationship-building skills.",
      "Counseling and Therapy":
        "Libra's desire to help others and create harmony makes them excellent counselors, therapists, or psychologists.",
    },
  ],
  Scorpio: [
    "With Scorpio in the 10th house, career success is driven by intensity, transformation, and deep passion. Scorpio is ruled by Pluto, the planet of transformation and power. Individuals with Scorpio in the 10th house are drawn to careers that involve investigation, power, and emotional depth. They excel in roles that require strategic thinking and the ability to manage crises or transformation.",
    {
      "Psychology and Counseling":
        "Scorpio's ability to delve into deep emotional layers makes them well-suited for careers in psychology, counseling, or therapy.",
      "Investigation and Forensics":
        "Roles in criminal investigation, forensic science, or detective work match Scorpio's desire to uncover hidden truths.",
      "Finance and Investment":
        "Careers in investment banking, stock trading, or financial management appeal to Scorpio's strategic mindset and desire for power.",
      "Medicine or Surgery":
        "The medical field, especially in areas requiring precision and care, like surgery, resonates with Scorpio's intense focus.",
      "Research and Science":
        "Careers in research, especially those involving deep analysis and uncovering new knowledge, fit Scorpio's investigative nature.",
    },
  ],
  Sagittarius: [
    "With Sagittarius in the 10th house, career success is focused on exploration, knowledge, and freedom. Sagittarius is ruled by Jupiter, the planet of expansion, optimism, and philosophy. Individuals with Sagittarius in the 10th house are drawn to careers that allow them to explore new horizons, travel, or share their knowledge and experiences with others. They are motivated by personal growth and the pursuit of truth.",
    {
      "Education and Teaching":
        "Sagittarius' love for knowledge and philosophy makes them great teachers, professors, or educational administrators.",
      "Travel and Tourism":
        "Careers in travel, tourism, or international business allow Sagittarius to explore new cultures and expand their horizons.",
      "Writing and Journalism":
        "Sagittarius excels in writing, especially travel journalism, or any field that involves sharing ideas and experiences.",
      "Philosophy and Religious Studies":
        "A career in philosophy, theology, or cultural studies appeals to Sagittarius' love for exploration of big ideas.",
      Entrepreneurship:
        "With their adventurous spirit, Sagittarius is often successful in starting businesses that cater to their passions, especially those related to travel or culture.",
    },
  ],
  Capricorn: [
    "With Capricorn in the 10th house, career success is linked to structure, discipline, and long-term planning. Capricorn is ruled by Saturn, the planet of responsibility and hard work. Individuals with Capricorn in the 10th house thrive in careers that require persistence, leadership, and authority. They excel in roles where they can build a stable foundation and achieve long-term success through determination and professionalism.",
    {
      "Government or Administrative Roles":
        "These individuals excel in structured environments like government services, public administration, or law enforcement, where discipline and responsibility are key.",
      "Corporate Leadership":
        "Careers in business management, finance, or entrepreneurship can be highly successful, especially in executive positions or roles requiring long-term planning.",
      "Engineering/Architecture":
        "Fields that require precision, planning, and hard work, such as engineering or architecture, are ideal for Capricorn's meticulous nature.",
      "Law or Judiciary":
        "Legal careers, including law, judgeships, or paralegal roles, align well with Capricorn's sense of justice and order.",
      "Real Estate Development":
        "Real estate, especially property development or investment, can offer financial success due to Capricorn's knack for planning and building from the ground up.",
    },
  ],
  Aquarius: [
    "With Aquarius in the 10th house, career success is focused on innovation, individuality, and social progress. Aquarius is ruled by Uranus, the planet of revolution and unconventionality. Individuals with Aquarius in the 10th house are drawn to careers that challenge the status quo, innovate, and contribute to society in unique ways. They excel in roles that involve technology, social change, and forward-thinking ideas.",
    {
      "Technology and Innovation":
        "Careers in tech, such as software development, engineering, or IT, are ideal for Aquarius' inventive nature.",
      "Social Reform and Activism":
        "Aquarius' desire for social justice and equality makes them excellent candidates for roles in activism, politics, or humanitarian work.",
      "Science and Research":
        "Careers in scientific research, particularly in cutting-edge or experimental fields, resonate with Aquarius' love for knowledge and progress.",
      "Inventor or Entrepreneur":
        "Aquarius' forward-thinking mindset makes them well-suited for entrepreneurship, especially in fields related to innovation and technology.",
      "Aerospace or Engineering":
        "Roles in the aerospace industry or other engineering fields allow Aquarius to push boundaries and work on groundbreaking projects.",
    },
  ],
  Pisces: [
    "With Pisces in the 10th house, career success is driven by creativity, compassion, and spiritual fulfillment. Pisces is ruled by Neptune, the planet of imagination, intuition, and idealism. Individuals with Pisces in the 10th house are often drawn to careers that allow them to express their artistic abilities, connect with others on an emotional level, or work in service to humanity. They are motivated by a desire to make the world a better place through their work.",
    {
      "Arts and Entertainment":
        "Pisces is naturally creative and artistic, making them well-suited for careers in music, art, or film.",
      "Psychology and Counseling":
        "Pisces' deep empathy and intuitive nature make them excellent counselors, therapists, or social workers.",
      "Healing Professions":
        "Careers in alternative healing, such as acupuncture, massage therapy, or holistic health, resonate with Pisces' desire to help others.",
      "Nonprofit Work and Social Services":
        "Pisces' compassion makes them ideal for roles in nonprofit organizations, social work, or charity-based careers.",
      "Writing and Creative Arts":
        "Writing, poetry, or other forms of creative expression are ideal for Pisces' imaginative and emotionally driven nature.",
    },
  ],
};

export const saturn_pos = [
  {
    Sign: "Capricorn",
    ...
    [
      {
        title: "Impulsiveness",
        content:
          "A tendency to act quickly without fully considering the consequences, which can sometimes lead to regret or missed opportunities.",
      },
      {
        title: "Fear of Losing Control",
        content:
          "A deep-seated need to maintain control over situations, leading to difficulty in trusting others or letting go.",
      },
      {
        title: "Emotional Reactivity",
        content:
          "Strong emotional reactions (anger, frustration) can arise quickly, affecting relationships and inner peace.",
      },
      {
        title: "Resistance to Vulnerability",
        content:
          "A subconscious fear of showing weakness or being hurt, which may prevent emotional growth.",
      },
      {
        title: "Difficulty Embracing Change",
        content:
          "Fearing the unknown, child may resist transformation or growth due to a subconscious attachment to the status quo.",
      },
    ],
    {
      manifestation: [
    ...
    [
      {
        ...
        content:
          "Subconscious resistance to change due to a need for security and stability.",
      },
      {
        title: "Stubbornness",
        content:
          "A tendency to hold onto old beliefs or routines, making it difficult to adapt or let go of the past.",
      },
      {
        title: "Attachment to Comfort",
        content:
          "A deep attachment to physical or emotional comfort, which may prevent embracing new challenges.",
      },
      {
        title: "Materialism",
        content:
          "A subconscious focus on possessions or external validation, which can cloud inner peace.",
      },
      {
        title: "Avoidance of Emotional Risk",
        content:
          "Fear of emotional loss or vulnerability, leading to avoiding new emotional experiences.",
      },
    ],
    {
      manifestation: [
    ...
    [
      {
        ...
        content:
          "Difficulty focusing on one thing or staying emotionally grounded due to a constant flow of thoughts.",
      },
      {
        title: "Avoiding Emotional Depth",
        content:
          "A tendency to intellectualize emotions rather than connect with them on a deeper level.",
      },
      {
        title: "Difficulty with Commitment",
        content:
          "A subconscious fear of being tied down or restricted in relationships or life choices.",
      },
      {
        title: "Shifting Attention",
        content:
          "Constantly changing interests or goals, making it hard to follow through with deep personal growth.",
      },
      {
        title: "Superficial Connections",
        content:
          "Tendency to form shallow relationships or avoid meaningful emotional bonds.",
      },
    ],
    {
      manifestation: [
    ...
    [
      {
        ...
        content:
          "Subconscious fears of being left behind or not being loved can create emotional blocks.",
      },
      {
        title: "Emotional Suppression",
        content:
          "A tendency to hide emotions, making it hard to process feelings and express vulnerability.",
      },
      {
        title: "Overprotectiveness",
        content:
          "A subconscious need to control and protect, which can create tension in relationships.",
      },
      {
        title: "Fear of Emotional Pain",
        content:
          "Avoiding emotional depth due to the fear of being hurt or experiencing loss.",
      },
      {
        title: "Difficulty Letting Go",
        content:
          "Subconsciously holding onto past emotional wounds or relationships, making it hard to move forward.",
      },
    ],
    {
      manifestation: [
    ...
    [
      {
        ...
        content:
          "Subconscious fear of not being accepted or seen for who they truly are.",
      },
      {
        title: "Overcompensation",
        content:
          "A tendency to seek constant validation or attention to feel emotionally secure.",
      },
      {
        title: "Emotional Pride",
        content:
          "A subconscious need to protect pride, which may prevent child from admitting vulnerability or emotional pain.",
      },
      {
        title: "Need for Control",
        content:
          "A tendency to control situations to ensure recognition and validation.",
      },
      {
        title: "Avoiding Vulnerability",
        content:
          "Subconsciously avoiding emotional depth or honesty due to fear of being judged or misunderstood.",
      },
    ],
    {
      manifestation: [
    ...
    [
      {
        title: "Perfectionism",
        content:
          "A subconscious drive to make everything perfect, which can lead to frustration or avoidance of emotional expression.",
      },
      {
        title: "Worry and Overthinking",
        content:
          "A tendency to overanalyze, creating mental and emotional stress.",
      },
      {
        title: "Fear of Imperfection",
        content:
          "Subconscious fears of making mistakes or being judged for not being 'good enough.'",
      },
      {
        title: "Difficulty Letting Go",
        content:
          "A tendency to hold on to minor details or past events, preventing emotional healing.",
      },
      {
        title: "Resistance to Vulnerability",
        content:
          "Fear of being imperfect or judged may lead child to avoid emotional depth or change.",
      },
    ],
    {
      manifestation: [
    ...
    [
      {
        ...
        content:
          "Subconscious fear of disagreements or being judged can lead to emotional avoidance.",
      },
      {
        title: "Lack of Self-Assertion",
        content:
          "Difficulty expressing personal boundaries or asserting their own needs.",
      },
      {
        title: "People-Pleasing",
        content:
          "A tendency to prioritize others' needs over their own, creating internal resentment.",
      },
      {
        title: "Over-Reliance on Relationships",
        content:
          "Subconscious belief that their worth is tied to how well they relate to others.",
      },
      {
        title: "Avoidance of Emotional Depth",
        content:
          "Fear of deep emotional confrontations or conflicts, leading to emotional detachment.",
      },
    ],
    {
      manifestation: [
    ...
    [
      {
        ...
        content:
          "Subconscious fear of being restricted emotionally or mentally.",
      },
      {
        title: "Avoidance of Deep Connections",
        content:
          "A tendency to avoid emotional depth or commitment in relationships.",
      },
      {
        title: "Restlessness and Escapism",
        content:
          "A tendency to escape difficult emotions by seeking constant change or adventure.",
      },
      {
        title: "Difficulty Confronting the Past",
        content:
          "Subconscious avoidance of unresolved issues or emotional wounds.",
      },
      {
        title: "Fear of Limitation",
        content:
          "Fear that emotional depth might limit their freedom or personal growth.",
      },
    ],
    {
      manifestation: [
    ...
    [
      {
        ...
        content:
          "Subconscious fear of not meeting their own or others' expectations, leading to emotional avoidance.",
      },
      {
        title: "Emotional Suppression",
        content:
          "A tendency to suppress emotions in favor of maintaining control or achieving goals.",
      },
      {
        title: "Over-Responsibility",
        content:
          "Taking on too much responsibility subconsciously, leading to emotional exhaustion.",
      },
      {
        title: "Fear of Vulnerability",
        content:
          "A subconscious belief that showing vulnerability will weaken their emotional strength.",
      },
      {
        title: "Difficulty Trusting Others",
        content:
          "Fear that relying on others emotionally might hinder their personal growth or success.",
      },
    ],
    {
      manifestation: [
    ...
    [
      {
        ...
        content:
          "Subconscious fear of being too emotionally attached to others.",
      },
      {
        title: "Emotional Detachment",
        content:
          "Tendency to detach from emotional experiences in favor of intellectual reasoning.",
      },
      {
        title: "Avoidance of Intimacy",
        content:
          "Difficulty forming deep emotional connections due to fear of loss of independence.",
      },
      {
        title: "Fear of Being Misunderstood",
        content:
          "Feeling that others cannot understand or accept their unique emotional world.",
      },
      {
        title: "Over-Intellectualization",
        content:
          "Tendency to intellectualize emotions rather than experiencing them.",
      },
    ],
    {
      manifestation: [
  ...
  Pisces: [
    ...
    [
      ...
      },
      {
        title: "Escapism",
        content:
          "Subconscious avoidance of painful emotions through daydreaming or fantasy.",
      },
      {
        title: "Lack of Boundaries",
        content:
          "Difficulty maintaining healthy emotional boundaries with others.",
      },
      {
      ...
      },
      {
        ...
        content:
          "Fear of being emotionally hurt by others' judgment or criticism.",
      },
    ],
    {
      manifestation: [
    ...
    [
      {
        title: "Fear of Vulnerability",
        content:
          "child might subconsciously guard emotions and resist expressing feelings due to a fear of being hurt or betrayed.",
      },
      {
        title: "Trust Issues",
        content:
          "There may be difficulty trusting others, particularly due to past experiences or fear of betrayal.",
      },
      {
        title: "Intense Emotions",
        content:
          "Strong emotional reactions, such as jealousy or anger, could arise unexpectedly, creating inner turmoil.",
      },
      {
        title: "Resistance to Change",
        content:
          "Subconscious fear of change or the unknown can create emotional blockages that prevent growth.",
      },
      {
        title: "Holding onto the Past",
        content:
          "child may struggle to let go of past emotional wounds, keeping them stuck in unresolved feelings or memories.",
      },
    ],
    {
      manifestation: [
...
export const nakshatraContent = {
  Ashwini: [
    {
      name: "Prince Charles",
      famous: "Heir to the British throne, philanthropy, charity",
      nakshatra:
        "Attractive personality, gives hope to others, charity, religious.",
    },
    {
      name: "Sania Mirza",
