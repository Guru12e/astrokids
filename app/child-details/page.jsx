            ...
            <div className="w-full flex flex-col gap-4">
              ...
              >
                ...
                <button
                  ...
                  className="px-4 w-full mx-auto py-2 font-bold rounded-lg flex justify-center items-center gap-2 new-gradient hover:brightness-110 transition-all capitalize"
                >
                ...
                <div className="self-center">
                  <button
                    ...
                    className={`p-2 text-sm font-bold rounded ${
                      resendTimer > 0
