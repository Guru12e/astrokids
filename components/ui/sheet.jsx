...
const sheetVariants = cva(
  "fixed z-[1000] gap-4 bg-primary p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 dark:bg-slate-950",
  {
    variants: {
      side: {
    ...
    <SheetPortal>
      ...
      >
        ...
        <SheetPrimitive.Close className='absolute top-8 right-8 transition-opacity outline-none'>
          <IoIosClose className='text-4xl text-accent' />
